...
export default function AdminGradesPage({
  ...
  const handleExport = () => {
    router.post('/admin/grades/export', {
      search: searchQuery,
      course: courseFilter === "all" ? "" : courseFilter,
      status: statusFilter === "all" ? "" : statusFilter,
    }, {
  ...
  const getGradeColor = (percentage: number) => {
    ...
    if (submission.quiz_data) {
      try {
        ...
        console.error('Error parsing direct quiz data for submission', submission.id, ':', error);
        console.error('Raw quiz_data:', submission.quiz_data);
      }
    }
    ...
    if (submission.quizContent && submission.quizContent.quiz_data) {
      try {
        ...
        console.error('Error parsing quiz data from relationship for submission', submission.id, ':', error);
        return 0;
      }
    }
      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400">Monitor and manage all quiz submissions and grades across the platform</p>
          </div>
                          ...
                          <TableCell>
                            <div className="flex items-center gap-3">
                              <Avatar className="w-8 h-8">
                                <AvatarImage src={`https://ui-avatars.com/api/?name=${submission.student_name || 'Student'}&background=red&color=white`} />
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                <DropdownMenuItem asChild>
                                  <Link href={`/admin/grades/${submission.id}`}>
                                    View Details
                                  </Link>
                                </DropdownMenuItem>
                              </DropdownMenuContent>
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    onClick={() => router.get('/admin/grades', { ...filters, page: submissions.current_page - 1 })}
                  >
                    Previous
                  </Button>
