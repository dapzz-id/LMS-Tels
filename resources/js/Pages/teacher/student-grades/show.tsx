...
export default function TeacherGradesShowPage({ submission, detailedResults }: Props) {
            ...
            <CardContent>
              <div className="flex items-center gap-3">
                <Avatar className="w-10 h-10">
                  <AvatarImage src={`https://ui-avatars.com/api/?name=${submission.user.nama_lengkap || 'Student'}&background=blue&color=white`} />
