    ...
    <div className="flex min-h-screen">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r bg-white dark:bg-slate-950 shadow-sm transition-transform duration-300 lg:relative lg:translate-x-0 ${
        ...
        <nav className="grid gap-1 px-2">
          <Link href="/">
            <Button variant="ghost" className="w-full justify-start gap-2 h-12 rounded-xl hover:bg-blue-50 dark:hover:bg-blue-950">
          ...
          <Link href="/dashboard/grades">
            <Button variant="ghost" className="w-full justify-start gap-2 h-12 rounded-xl bg-blue-50 dark:bg-blue-950 hover:bg-blue-50 dark:hover:bg-blue-950">
